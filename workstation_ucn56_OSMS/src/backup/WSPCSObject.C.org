   ...
   for (optionCounter = 1; optionCounter < numOptions; optionCounter++)
   {
      ...
      for (optionIndex = 0; optionIndex < NUM_OPTIONS; optionIndex++)
      {
         if (0 == strcmp(options[optionIndex].str, argv[optionCounter]))
         {
            ...
            cout << "   found a valid option = " << argv[optionCounter]
                 << endl;
...
void WSPCSObject::startAll()
{
   ...
   if (0 == (pid = fork()))
   {
      ...
      //execlp("rtm", "rtm", "-r", "../pictures/YGN3and4.pctx", (char *)0);	//for YGN34EOF by feel9 20200211
      execlp("rtm", "rtm", "-r", "../pictures_ygn34EOF/YGN3and4.pctx", (char *)0);
   ...
   if (0 == (pid = fork()))
   {
      ...
      execlp("Timer", "Timer", "-a", "YGN3and4", "-p", "TheTimer", (char *)0);
   ...
   if (0 != strcmp(IPO.getHostName(1),""))
   {
      ...
      if (0 == (pid = fork()))
      {
         ...
         execlp("CommLink", "CommLink1", digitStr, IPO.getHostName(1), 
	        (char *)0 );
   ...
   if (0 != strcmp(IPO.getHostName(2),""))
   {
      ...
      if (0 == (pid = fork()))
      {
         ...
         execlp("CommLink", "CommLink2", digitStr, IPO.getHostName(2), 
	        (char *)0 );
...
{
   system("Execute -a YGN3and4 -r rtm -c \"{::YGN3and4.PicYGN_WarmStart.ShowProgress();}\" > /dev/null");
}
