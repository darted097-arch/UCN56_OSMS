...
//
// ***************************************************************************
//  This module gets the DBWSPCS parameters from the DBWSPCS configuration
//  file.
// ***************************************************************************
//
// ***************************************************************************
...
static void exitDBMsg(char * args[], char strings[MAX_STRINGS][MAX_WORD_LEN+1], 
		    int strCtr);

void DBWSPCSObject::setDBWSPCSinfo(char * fn)
{
   ifstream	cfgFile;
   ...
   args[argCtr++] = "DBWSPCSObject::setDBWSPCSinfo";

   cout << "\nsetDBWSPCSinfo(" << fn << ")" << endl;
   cfgFile.open(fn);
   if(!(cfgFile.good()))
   {
   ...
   cout << "***** DBWSPCS Configuration file = " << fn 
